...
for entry in matl.entries:
    ...
    # Add a new parameter.
    param = ssbh_data_py.matl_data.FloatParam(
        ssbh_data_py.matl_data.ParamId.CustomFloat10, 0.9
    )
    ...
    param = ssbh_data_py.matl_data.SamplerParam(
        ssbh_data_py.matl_data.ParamId.Sampler1, sampler
    )
    ...
    blend_state.destination_color = (
        ssbh_data_py.matl_data.BlendFactor.OneMinusSourceAlpha
    )

    param = ssbh_data_py.matl_data.BlendStateParam(
        ssbh_data_py.matl_data.ParamId.BlendState0, blend_state
    )
    ...
    param = ssbh_data_py.matl_data.RasterizerStateParam(
        ssbh_data_py.matl_data.ParamId.RasterizerState0, rasterizer_state
    )
