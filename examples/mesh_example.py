...
for o in mesh.objects:
    ...
    normals = ssbh_data_py.mesh_data.calculate_smooth_normals(
        o.positions[0].data, o.vertex_indices
    )
    ...
    for influence in o.bone_influences:
        ...
        print(
            influence.vertex_weights[0].vertex_index,
            influence.vertex_weights[0].vertex_weight,
        )
